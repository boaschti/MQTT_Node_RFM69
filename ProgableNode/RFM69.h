...
#define RF69_MAX_DATA_LEN       61 // to take advantage of the built in AES/CRC we want to limit the frame size to the internal FIFO size (66 bytes - 3 bytes overhead - 2 bytes crc)
    ...
    #define RF69_SPI_CS             8 // B0 is the SPI slave select pin, for instance D10 on ATmega328
  #else
    #define RF69_SPI_CS             SS // B0 is the SPI slave select pin, for instance D10 on ATmega328
  #endif
#endif
...
// INT0 on AVRs should be connected to RFM69's DIO0 (ex on ATmega328 it's D2, on ATmega644/1284 it's D2)
#if defined(__AVR_ATmega168__) || defined(__AVR_ATmega328P__) || defined(__AVR_ATmega88) || defined(__AVR_ATmega8__) || defined(__AVR_ATmega88__)
  //#define RF69_IRQ_PIN          2 //INT0 = 2, INT1 = 3
  //#define RF69_IRQ_NUM          0
  //Nur für Bastis Board
  #define RF69_IRQ_PIN          3 //INT0 = 2, INT1 = 3
  ...
  #define RF69_IRQ_PIN          4//4
  #define RF69_IRQ_NUM          digitalPinToInterrupt(RF69_IRQ_PIN)
  #undef INTERRUPTS_DISABLE_OK
  #define INTERRUPTS_DISABLE_OK 0
#else 
  #define RF69_IRQ_PIN          2 //2
  #define RF69_IRQ_NUM          0 // 
#endif


#define CSMA_LIMIT              -72 // upper RX signal sensitivity threshold in dBm for carrier sense access
...
#define RF69_CSMA_LIMIT_MS 1000  //sw
...
class RFM69 {
  public:
    ...
    virtual bool sendWithRetry(uint8_t toAddress, const void* buffer, uint8_t bufferSize, uint8_t retries=4, uint8_t retryWaitTime=250); // 40ms roundtrip req for 61byte packets
